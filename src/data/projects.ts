...
export const projects: Project[] = [
  {
    ...
    cover: noir,
    span: "tall",
    opis: "Okładka albumu długogrającego z pogranicza techno i ambientu. Czarna płaszczyzna, jeden refleks światła i tytuł ustawiony tak nisko, że prawie schodzi z kadru.",
  ...
  },
  {
    ...
    cover: mono,
    span: "wide",
    opis: "EP zbudowana na jednym motywie dźwiękowym dostała okładkę zbudowaną na jednym module graficznym, powielanym w rytmie utworów.",
